...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
   ...
   <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "暂时木有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  
      <td><?php echo ($i+$num); ?></td>      
      <td><?php echo ($vo["title"]); ?></td>  
      <td><?php echo ($vo["s_desc"]); ?></td>
      <td><?php echo ($vo["id"]); ?></td>      
      <td>
      <div class="button-group">
      <a type="button" class="button border-main" href="<?php echo U('/Adminls/Cates/update',array('id'=>$vo['id']));?>"><span class="icon-edit"></span>修改</a>
       <a class="button border-red" href="<?php echo U('/Adminls/Cates/delete',array('id'=>$vo['id']));?>" onclick="return del(17)"><span class="icon-trash-o"></span> 删除</a>
      </div>
      </td>
