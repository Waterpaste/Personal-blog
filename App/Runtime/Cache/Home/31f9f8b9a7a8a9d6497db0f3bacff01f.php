...
<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
 ...
 <div class="container"> 
  <article>
      ...
      <div class="bloglist">
      <?php if(is_array($searchs)): $i = 0; $__LIST__ = $searchs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><div class="well well-lg">
        <h3><a href="<?php echo U('/n-'.$s[id]);?>"><?php echo ($s["p_title"]); ?></a></h3>
        <ul>
          <p>
          <?php echo (htmlspecialchars_decode($s["content"])); ?>         	
         </p>   
        </ul>
        <a href="<?php echo U('New/index',array('id'=>$s['id']));?>" target="_blank" class="readmore">阅读全文&gt;&gt;</a>
        <p class="autor"><span class="lm f_l"><a href="#"><?php echo ($s["title"]); ?></a></span><span class="dtime f_l"><?php echo (mb_substr($s["date"],0,10,'UTF-8')); ?></span><span class="viewnum f_r">浏览（<a href="#"><?php echo ($s["count"]); ?></a>）</span><span class="pingl f_r">评论（<a href="#"><?php echo ($s["comment"]); ?></a>）</span></p>
