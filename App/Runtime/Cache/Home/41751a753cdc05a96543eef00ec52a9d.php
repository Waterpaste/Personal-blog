 ...
 <div class="container"> 
  <article>
      ...
      <?php if(is_array($post)): $i = 0; $__LIST__ = $post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="well well-lg">
        ...
        <a href="<?php echo U('New/index',array('id'=>$vo['id']));?>" target="_blank" class="readmore">阅读全文&gt;&gt;</a>
        <p class="autor"><span class="lm f_l"><a href="#"><?php echo ($vo["title"]); ?></a></span><span class="dtime f_l"><?php echo (mb_substr($vo["date"],0,10,'UTF-8')); ?></span><span class="viewnum f_r">浏览（<a href="#"><?php echo ($vo["count"]); ?></a>）</span><span class="pingl f_r">评论（<a href="#"><?php echo ($vo["comment"]); ?></a>）</span></p>
